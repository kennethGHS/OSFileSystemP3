...
public:
    ...
    // @{
    /// get/set user color
    QColor userColor() const { return userColor_; }

    void setUserColor(QColor c) { userColor_ = c; }

    // @}

    // @{
    /// get/set path color
    QColor pathColor() const { return pathColor_; }

    void setPathColor(QColor c) { pathColor_ = c; }
    ...
    void setUsername(const QString &string) {
        username = string;
    }
